...
async function handleClick(row, col) {
            ...
            if (movedPiece instanceof Pawn) {
                ...
                if (output === "PROMOTE") {
                    ...
                    showPromotionMenu(choice => {
                        ...
                        saveGameState(board, null, turn, 'rookLevel');
    ...
    redraw();
    await saveGameState(board, clickedPiece, turn, 'rookLevel');
...
async function restartGame() {
    ...
    redraw();
    gameFinished = false;
    await saveGameState(board, null, 'white', 'rookLevel');
}
...
async function blackBot() {
    ...
    await saveGameState(board, null, 'black', 'rookLevel');
    let gameStatus = gameOver(board);
    if (gameStatus != null) {
        gameFinished = true;
        triggerReset(gameStatus);
